!function e(t, n, r) {
  ...
  1: [function (require, module, exports) {
    module.exports = {
      intro: {
        ...
        level: 0,
        content: {
          name: "Welcome to Bears Ears",
          number: "01",
          videoId: "kESZx1Q6kmE",
          mobileVideoId: "ZmZc-yteCSo",
          "no-auto-next-button": !0
        },
        titles: [{id: "1", start: "4", end: "7.5"}, {id: "0", start: "2", end: "7.5"}, {
          id: "2",
          start: "84.5",
          end: "300"
        }]
      ...
      culture: {
        ...
        content: {
          ...
          number: "01",
          icons: ["video"],
          description: "The history of Bears Ears is written in rocks and sandstone walls.",
          image: "01_culture.jpg",
          videoId: "dzamlW_puAs",
          showNextCard: !1,
          mapIcon: "escaping_places.svg",
          "video-show-skip": !0,
          captions: [{id: "0", content: "Please help us to protect this place", start: "78", end: "80"}, {
            id: "1",
            content: "for not only us, but for everybody.",
            start: "80",
            end: "82.5"
          }, {id: "2", content: "Thank you.", start: "82.5", end: "300"}]
        }
      },
      "escaping-places": {
        ...
        content: {
          name: "Escaping Places",
          number: "1.1",
          icons: ["vrvideo"],
          image: "11_escaping_places_intro.jpg",
          description: "Learn how Bears Ears has long served as a refuge from conflict.",
          videoId: "kg2P-ObtEGs",
          "no-auto-next-button": !0,
          "powered-by-earch": !0,
          mapCoord: {lat: 37.65304, lng: -110.1618},
          mapIcon: "escaping_places.svg",
          titlecard: {
            narrators: [{name: "Willie", image: "willie_grayeyes.jpg"}, {
              name: "Jason",
              image: "jason_nez.jpg"
            }]
          },
      ...
      "escaping-places-video": {
        ...
        content: {
          name: "Escaping Places",
          number: "1.1",
          image: "111_escaping_places_will_and_jaso.jpg",
          videoId: "vZwgTdPqIbo",
          videoVR: "./assets/videos/escaping-places.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/escaping-places.mp4",
          narrators: [{
            name: "Willie Grayeyes",
            image: "willie_grayeyes.jpg",
            times: [[2, 9], [27, 49], [96, 151]]
          }, {name: "Jason Nez", image: "jason_nez.jpg", times: [[12, 26], [52, 95]]}],
          mapIcon: "escaping_places.svg",
          showNextCard: !0
        }
      },
      "living-museum": {
        next: "living-museum-video",
        prev: "escaping-places",
        type: "video",
        level: 2,
        json: "12_living_museum.json",
        parent: "culture",
        url: "culture/living-museum",
        content: {
          name: "A Living Museum",
          number: "1.2",
          image: "12_living_museum_intro.jpg",
          icons: ["vrvideo"],
          videoId: "-QvwJfmkHlE",
          "no-auto-next-button": !0,
          "powered-by-earch": !0,
          mapLocation: "location01",
          description: "Visit the Wolfman Panel and River House dwelling.",
          mapCoord: {lat: 37.2228, lng: -109.68791},
          mapIcon: "living_museum_river.svg",
          titlecard: {
            narrators: [{name: "Lyle", image: "lyle_balenquah.jpg"}, {
              name: "Riley",
              image: "riley_balenquah.jpg"
            }]
          },
          showNextCard: !1
        }
      ...
      "living-museum-video": {
        ...
        content: {
          name: "A Living Museum",
          number: "1.2",
          image: "121_living_museum.jpg",
          description: "Visit the Wolfman Panel and River House dwelling.",
          videoVR: "./assets/videos/a-living-museum.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/a-living-museum.mp4",
          videoId: "388k8TlhF1w",
          narrators: [{
            name: "Lyle Balenquah",
            image: "lyle_balenquah.jpg",
            times: [[8, 74], [118, 153]]
          }, {name: "Riley Balenquah", image: "riley_balenquah.jpg", times: [[80, 116]]}],
          mapIcon: "living_museum_river.svg",
          showNextCard: !0
        }
      },
      "living-museum-pano": {
        ...
        content: {
          ...
          icons: ["streetview"],
          videoId: "",
          mapCoord: {lat: 37.2743, lng: -109.64654},
          audio: "wolfman",
          thumbnail: "wolfman-pano/pano-thumb.jpg",
          "tile-folder": "wolfman-pano/",
          bound: {sw: {lat: -37.71, lng: -142.8}, ne: {lat: 37.71, lng: 142.8}},
          markers: [{
            mapCoord: {lat: 3, lng: -101},
            type: "info",
          ...
          narrators: [{name: "Lyle Balenquah", image: "lyle_balenquah.jpg", times: [[0, 67]]}],
          showNextCard: !0,
          titlecard: {narrators: [{name: "Lyle", image: "lyle_balenquah.jpg"}]}
        }
      },
      "living-museum-streetview": {
        next: "history-horseback",
        prev: "escaping-places",
        type: "streetview",
        level: 2,
        json: "12_living_museum.json",
        parent: "culture",
        url: "culture/river-house-ruin",
        content: {
          name: "River House Ruin",
          number: "1.4",
          description: "Wander well preserved cliff dwellings.",
          image: "123_river_house_ruin.jpg",
          icons: ["streetview"],
          mapLocation: "location01",
          mapCoord: {lat: 37.2228, lng: -109.60791},
          audio: "riverhouse",
          mapIcon: "living_museum_river.svg",
          streetviews: {
            "position-1": {
              viewCoord: {lat: 37.2230272, lng: -109.688071},
              pov: {heading: 43, pitch: 0},
              markers: [{pov: {heading: 49, pitch: -20}, "goto": "position-2"}, {
                pov: {heading: 13, pitch: 18},
                type: "info",
                text: "Habitation",
                detail: "Charring on the walls of standing structures is an indication of habitation. It’s assumed that areas without burn scars were granaries used for food storage."
              }, {
                pov: {heading: 37, pitch: 14},
                type: "info",
                text: "Exposure",
                detail: "Puebloean dwellings were typically oriented to favor a southern exposure in order to get the most warmth from the winter sun."
              }]
            },
            "position-2": {
              viewCoord: {lat: 37.2230269, lng: -109.6879905},
              markers: [{pov: {heading: 275, pitch: 10}, "goto": "position-1"}, {
                pov: {heading: 52, pitch: 22},
                "goto": "position-3"
              }, {
                pov: {heading: .4, pitch: 36.7},
                type: "info",
                text: "Habitation",
                detail: "Charring on the walls of standing structures is an indication of habitation. It’s assumed that areas without burn scars were granaries used for food storage."
              }, {
                pov: {heading: 61.8, pitch: 32.8},
                type: "info",
                text: "Exposure",
                detail: "Puebloean dwellings were typically oriented to favor a southern exposure in order to get the most warmth from the winter sun."
              }, {
                pov: {heading: 38.6, pitch: 43},
                type: "info",
                text: "Art",
                detail: "An ecosophical theory of rock art suggests that curvalinears, like the snake on the back alcove, come from the images seen during trance-states which are thought to be similar for all who experience them. These patterns show up in rock art from around the world."
              }]
            },
            "position-3": {
              viewCoord: {lat: 37.2230275, lng: -109.6879167},
              markers: [{pov: {heading: 172, pitch: -20}, "goto": "position-2"}, {
                pov: {heading: 111, pitch: -35},
                "goto": "position-4"
              }, {pov: {heading: 56, pitch: -9}, "goto": "position-5"}, {
                pov: {heading: 6.6, pitch: 33},
                type: "info",
                text: "Exposure",
                detail: "Puebloean dwellings were typically oriented to favor a southern exposure in order to get the most warmth from the winter sun."
              }, {
                pov: {heading: 330, pitch: 62},
                type: "info",
                text: "Art",
                detail: "An ecosophical theory of rock art suggests that curvalinears, like the snake on the back alcove, come from the images seen during trance-states which are thought to be similar for all who experience them. These patterns show up in rock art from around the world."
              }]
            ...
            "position-4": {
              viewCoord: {lat: 37.2230275, lng: -109.6878614},
              markers: [{pov: {heading: 360, pitch: -10}, "goto": "position-3"}, {
                pov: {heading: 80, pitch: 9},
                "goto": "position-5"
              }, {
                pov: {heading: 303, pitch: 39},
                type: "info",
                text: "Habitation",
                detail: "Charring on the walls of standing structures is an indication of habitation. It’s assumed that areas without burn scars were granaries used for food storage."
              }, {
                pov: {heading: 65, pitch: 31},
                type: "info",
                text: "Exposure",
                detail: "Puebloean dwellings were typically oriented to favor a southern exposure in order to get the most warmth from the winter sun."
              }, {
                pov: {heading: 2.6, pitch: 57},
                type: "info",
                text: "Art",
                detail: "An ecosophical theory of rock art suggests that curvalinears, like the snake on the back alcove, come from the images seen during trance-states which are thought to be similar for all who experience them. These patterns show up in rock art from around the world."
              }]
            ...
            "position-5": {
              viewCoord: {lat: 37.2230267, lng: -109.6878017},
              markers: [{pov: {heading: 260, pitch: -23}, "goto": "position-3"}, {
                pov: {heading: 215, pitch: -27},
                "goto": "position-4"
              }, {
                pov: {heading: 15, pitch: 33},
                type: "info",
                text: "Habitation",
                detail: "Charring on the walls of standing structures is an indication of habitation. It’s assumed that areas without burn scars were granaries used for food storage."
              }, {
                pov: {heading: 285, pitch: 28},
                type: "info",
                text: "Exposure",
                detail: "Puebloean dwellings were typically oriented to favor a southern exposure in order to get the most warmth from the winter sun."
              }, {
                pov: {heading: 303, pitch: 43},
                type: "info",
                text: "Art",
                detail: "An ecosophical theory of rock art suggests that curvalinears, like the snake on the back alcove, come from the images seen during trance-states which are thought to be similar for all who experience them. These patterns show up in rock art from around the world."
              }]
          ...
          narrators: [{name: "Lyle Balenquah", image: "lyle_balenquah.jpg", times: [[0, 77]]}],
          showNextCard: !0,
          titlecard: {narrators: [{name: "Lyle", image: "lyle_balenquah.jpg"}]}
        }
      },
      "history-horseback": {
        next: "history-horseback-video",
        prev: "living-museum",
        type: "video",
        level: 2,
        json: "13_history_horseback.json",
        parent: "culture",
        url: "culture/history-horseback",
        content: {
          name: "History on Horseback",
          number: "1.5",
          description: "Ride Posey's Trail.",
          icons: ["vrvideo"],
          image: "13_history_horse_back_intro.jpg",
          videoId: "3L3a_m7uQJY",
          "no-auto-next-button": !0,
          "powered-by-earch": !0,
          mapCoord: {lat: 37.515912, lng: -109.646259},
          mapIcon: "history_horseback.svg",
          titlecard: {narrators: [{name: "Malcolm", image: "malcolm_lehi.jpg"}]},
          showNextCard: !1
        }
      },
      "history-horseback-video": {
        next: "cave-spring",
        prev: "living-museum",
        type: "video",
        level: 3,
        ...
        content: {
          name: "History on Horseback",
          number: "1.5",
          image: "131_history_on_horseback.jpg",
          videoId: "LBVXTr2LPmE",
          videoVR: "./assets/videos/history-on-horseback.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/history-on-horseback.mp4",
          narrators: [{name: "Malcolm Lehi", image: "malcolm_lehi.jpg", times: [[6, 125]]}],
          mapIcon: "history_horseback.svg",
          showNextCard: !0
        }
      },
      "cave-spring": {
        ...
        content: {
          name: "A Water Offering",
          number: "1.6",
          description: "Feel the sacredness of Bears Ears.",
          icons: ["vrvideo"],
          image: "14_cave_spring_intro.jpg",
          videoId: "tQvv-3IPO9E",
          "no-auto-next-button": !0,
          "powered-by-earch": !0,
          mapCoord: {lat: 37.52632, lng: -109.73215},
          mapIcon: "cave_spring.svg",
          titlecard: {narrators: [{name: "Octavius", image: "octavius_seowtewa.jpg"}]},
          showNextCard: !1
        }
      },
      "cave-spring-video": {
        ...
        content: {
          ...
          number: "1.6",
          icons: ["vrvideo", "video"],
          image: "141_cave_spring_offering.jpg",
          videoId: "nb4mX4F9Z1w",
          videoVR: "./assets/videos/cave-spring-offering.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/cave-spring-offering.mp4",
          narrators: [{name: "Octavius Seowtewa", image: "octavius_seowtewa.jpg", times: [[6, 146]]}],
          mapIcon: "cave_spring.svg",
          showNextCard: !0
        }
      },
      sport: {
        ...
        content: {
          ...
          icons: ["video"],
          image: "02_sport.jpg",
          description: "From trail runs on quiet mesas to expansive views from the top of talus towers, Bears Ears is as playful as it is reverent.",
          videoId: "rlYb9VE5j28",
          "powered-by-earch": !0,
          showNextCard: !1,
          "video-show-skip": !0,
          mapIcon: "north_six_shooter.svg"
        }
      },
      "north-six-shooter": {
        next: "north-six-shooter-video",
        prev: "history-horseback",
        type: "video",
        level: 2,
        json: "21_north_six_shooter.json",
        parent: "sport",
        url: "sport/north-six-shooter",
        content: {
          name: "North Six Shooter",
          number: "2.1",
          description: "Tommy Caldwell sends the Lightning Bolt Cracks.",
          icons: ["vrvideo"],
          image: "21_north_6_shooter_climb.jpg",
          videoId: "Vy4fR-XeWco",
          "powered-by-earch": !0,
          "no-auto-next-button": !0,
          mapCoord: {lat: 38.1375, lng: -109.66805},
          mapIcon: "north_six_shooter.svg",
          titlecard: {
            narrators: [{name: "Tommy", image: "tommy_caldwell.jpg"}, {
              name: "Brady",
              image: "brady_robinson.jpg"
            }]
          },
          showNextCard: !1
        }
      },
      "north-six-shooter-video": {
        next: "bikepack-giants",
        prev: "sport",
        type: "video",
        level: 3,
        parent: "sport",
        ...
        content: {
          ...
          description: "Tommy Caldwell sends the Lightning Bolt Cracks.",
          videoId: "7bnrBbVsH_8",
          videoVR: "./assets/videos/summit-the-north-six-shooter.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/summit-the-north-six-shooter.mp4",
          narrators: [{
            name: "Tommy Caldwell",
            image: "tommy_caldwell.jpg",
            times: [[0, 2], [6, 116]]
          }, {name: "Brady Robinson", image: "brady_robinson.jpg", times: [[3, 5]]}],
          mapCoord: {lat: 38.1375, lng: -109.66805},
          mapIcon: "north_six_shooter.svg",
          showNextCard: !0
        }
      ...
      "bikepack-giants": {
        next: "bikepack-giants-video",
        prev: "north-six-shooter",
        type: "video",
        level: 2,
        json: "22_bikepack_giants.json",
        parent: "sport",
        url: "sport/bikepack-with-giants",
        content: {
          name: "Bikepack with Giants",
          number: "2.2",
          icons: ["vrvideo"],
          image: "22_bikepacking_lockheart_basin.jpg",
          description: "Two photographers explore Lockhart Basin.",
          videoId: "ZzPcpmstPqg",
          mapCoord: {lat: 38.38467, lng: -109.7014},
          mapIcon: "lockhart_basin.svg",
          titlecard: {
            narrators: [{name: "Andrew", image: "andrew_burr.jpg"}, {
              name: "Steve",
              image: "steve_fassbinder.jpg"
            }]
          },
          showNextCard: !1,
          "powered-by-earch": !0
      ...
      "bikepack-giants-video": {
        ...
        content: {
          ...
          description: "Two photographers explore Lockhart Basin.",
          videoId: "Rpful6DhWE0",
          videoVR: "./assets/videos/bikepacking-with-giants.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/bikepacking-with-giants.mp4",
          narrators: [{
            name: "Andrew Burr",
            image: "andrew_burr.jpg",
            times: [[6, 33], [90, 134]]
          }, {name: "Steve Fassbinder", image: "steve_fassbinder.jpg", times: [[39, 84], [149, 160]]}],
          mapCoord: {lat: 38.38467, lng: -109.7014},
          mapIcon: "lockhart_basin.svg",
          showNextCard: !0
        }
      ...
      "indian-creek": {
        next: "indian-creek-video",
        prev: "bikepack-giants",
        type: "video",
        level: 2,
        json: "23_indian_creek.json",
        parent: "sport",
        url: "sport/indian-creek",
        content: {
          name: "Climb Sandstone Splitters",
          number: "2.3",
          icons: ["vrvideo"],
          image: "23_indian_creek.jpg",
          description: "A local shows off Indian Creek.",
          videoId: "rl-DptEs_v4",
          mapCoord: {lat: 38.06999, lng: -109.55049},
          mapIcon: "indian_creek.svg",
          titlecard: {narrators: [{name: "Kitty", image: "kitty_calhoun.jpg"}]},
          showNextCard: !1,
          "powered-by-earch": !0
        }
      },
      "indian-creek-video": {
        ...
        content: {
          ...
          description: "A local shows off Indian Creek.",
          videoId: "nnIIZS5iqPU",
          videoVR: "./assets/videos/climbing-sandstone-splitters.mp4",
          videoVRCDN: "https://storage.googleapis.com/patagonia-bearsears.appspot.com/videos/climbing-sandstone-splitters.mp4",
          narrators: [{name: "Kitty Calhoun", image: "kitty_calhoun.jpg", times: [[5, 147]]}],
          mapCoord: {lat: 38.06999, lng: -109.55049},
          mapIcon: "indian_creek.svg",
          showNextCard: !0
        }
      ...
      "trail-run-gods": {
        next: "trail-run-gods-video",
        prev: "indian-creek",
        type: "video",
        level: 2,
        json: "24_trail_run_gods.json",
        parent: "sport",
        url: "sport/trail-run-gods",
        content: {
          name: "Trail Run with Gods",
          number: "2.4",
          icons: ["video"],
          image: "24_trail_running_with_gods.jpg",
          description: "Luke Nelson finds new trails in the Valley of the Gods.",
          videoId: "Xmou_k6gE9U",
          mapCoord: {lat: 37.26694, lng: -109.83264},
          mapIcon: "trail_running.svg",
          titlecard: {narrators: [{name: "Luke", image: "luke_nelson.jpg"}]},
          showNextCard: !1,
          "powered-by-earch": !0
        }
      },
      "trail-run-gods-video": {
        next: "take-action",
        prev: "indian-creek",
        type: "video",
        level: 3,
        ...
        content: {
          ...
          description: "Luke Nelson finds new trails in the Valley of the Gods.",
          videoId: "mHo-ePKtgqU",
          narrators: [{name: "Luke Nelson", image: "luke_nelson.jpg", times: [[3, 116]]}],
          mapCoord: {lat: 37.26694, lng: -109.83264},
          mapIcon: "trail_running.svg",
          showNextCard: !0
        }
      ...
      "take-action": {
        ...
        content: {
          ...
          number: "03",
          image: "03_action.jpg",
          description: "World Credit Savings is the financial concern regulated by FSRA.",
          videoId: "Bc-Ypj7zttU",
          showNextCard: !1
        }
      },
      "take-action-film": {
        next: "escaping-places-intro",
        type: "video",
        level: 3,
        json: "01_culture.json",
        content: {name: "Take Action", number: "03", videoId: "Bc-Ypj7zttU"}
      },
      "forex": {
        prev: "indian-creek",
        type: "forex",
      ...
      "take-action-film": {
        ...
        level: 3,
        json: "01_culture.json",
        content: {name: "Forex", number: "03", videoId: "Bc-Ypj7zttU"}
      },
      map: {
        type: "map",
        level: 4,
        ...
        content: {
          ...
          "state-labels": [{
            ...
            size: {x: 44.1, y: 16},
            anchor: {x: 44.1, y: 16},
            position: {lat: 37.02, lng: -109.07}
          }, {
            icon: "arizona.svg",
            size: {x: 77.8, y: 16},
            anchor: {x: 77.8, y: 0},
            position: {lat: 36.987, lng: -109.07}
          }, {
            icon: "colorado.svg",
            size: {x: 88.5, y: 16},
            anchor: {x: 0, y: 16},
            position: {lat: 37.02, lng: -109.02}
          }, {
            icon: "newmexico.svg",
            size: {x: 126.5, y: 16},
            anchor: {x: 0, y: 0},
            position: {lat: 36.987, lng: -109.02}
          }]
        }
      },
      credits: {type: "credits", level: 4, url: "credits", content: {name: "Credits"}},
      "menu--culture": {type: "menu", level: 4, menu: "full", card: "culture", content: {name: "Menu"}},
      "menu--sport": {type: "menu", level: 4, menu: "full", card: "sport", content: {name: "Menu"}},
      experience: {
        next: "",
        prev: "",
        type: "video",
  ...
  3: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.audio", []),
    ...
    audioController.prototype.init = function () {
      this.$http({method: "GET", url: "/content/pages/" + this.json}).then(function (response) {
        this.$scope.supplemental = response.data
      }.bind(this), function (response) {
      }.bind(this)), "playing" !== this.$scope.currentState && this._isMobileOrTouch() && (this.$scope.showPlayOverlay = !0), this.setupAudioPlayer()
    }, audioController.prototype.setupAudioPlayer = function () {
      var audioDir = "./assets/audio/", audioOgg = audioDir + this.content.audio + ".ogg",
        audioMp3 = audioDir + this.content.audio + ".mp3", audioSrcs = this.$element.find("#audio source");
      ...
      for (var narrator in narrators) for (var time in narrators[narrator].times) {
  ...
  4: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.breadcrumb", []),
    ...
    breadcrumbController.prototype.visit = function (url) {
      ...
      if (this._show(), this.$scope.crumbs = this.$scope.crumbs.splice(0, 1), next.parent) {
        ...
        this.$scope.crumbs.push({name: parent.content.name, level: parent.level, link: next.parent})
      }
  ...
  }, {"../../content/content.json": 1, angular: 26}],
  5: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.credits", []),
    ...
    creditsController.prototype._init = function () {
    }, creditsController.prototype._changeSection = function (object, next) {
  ...
  6: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.header", []),
    ...
    headerController.prototype.shareFB = function () {
      ...
      var shareText = "World Credit Savings is the financial concern regulated by FSRA. Explore more at wc-s.com",
  ...
  7: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.intro", []),
      content = require("../../content/content.json"),
    ...
    introController.prototype.init = function ($event) {
      ...
      this.$scope.showPreview && (this.previewPlayer = new YT.Player(this.$element.find("#intro-preview")[0], {
        ...
        events: {onStateChange: this._onPlayerStateChange.bind(this), onReady: this._onPreviewPlayerReady.bind(this)}
      })), this.player = new YT.Player(this.$element.find("#intro-video")[0], {
        height: "100%",
        width: "100%",
        videoId: this.content.intro.content.videoId,
        playerVars: {autoplay: 0, autohide: 1, showinfo: 0, controls: 0, rel: 0, modestbranding: 1, playsinline: 1},
        events: {onStateChange: this._onPlayerStateChange.bind(this), onReady: this._onPlayerReady.bind(this)}
      })
  ...
  8: [function (require, module, exports) {
    ...
    mapController.prototype._init = function () {
      ...
      var config = {attributes: !0, childList: !0, characterData: !0, subtree: !0};
      this.observer.observe(document.getElementById("map-container"), config), this.mapService.mapsInitialized.then(function () {
        this.center = new google.maps.LatLng(37.79676, (-109.97589)), this.map = new google.maps.Map(document.getElementById(""), {
          ...
          styles: [{stylers: [{visibility: "off"}]}, {
            ...
            stylers: [{color: "#ffffff"}, {visibility: "on"}, {weight: 1.5}]
          }]
        });
        for (var i in this.stateLabels) new google.maps.Marker({
          ...
          }, map: this.map, position: this.stateLabels[i].position, opacity: .7
        });
      ...
      var origin = document.location.origin, base = $("base").attr("href").replace(/^\/|\/$/g, ""),
        kmlPath = "assets/map/border.kml", kmlUrl = origin + "/" + base + "/" + kmlPath;
      if (window.location.href.indexOf("localhost") > -1) {
        ...
        new google.maps.KmlLayer({url: kmlUrl, map: this.map, preserveViewport: !0, suppressInfoWindows: !0})
      }
      ...
      for (var i in this.places) {
        var type = this.places[i].content.icons[0], category = this.places[i].parent,
          iconPath = "./assets/icons/type_" + type + "_" + category + ".svg", marker = new google.maps.Marker({
      ...
      google.maps.event.addListener(this.map, "projection_changed", function () {
        this.overlay = new google.maps.OverlayView, this.overlay.draw = function () {
        }, this.overlay.setMap(this.map), "desktop" == this.configService.size && this._updateCenter();
      ...
      return function (e) {
        ...
        var coords;
        if (!marker && this.$scope.currentMarker && this.overlay.getProjection) coords = this.overlay.getProjection().fromLatLngToContainerPixel(this.$scope.currentMarker.getPosition()); else {
        ...
        "smartphone" != this.configService.size ? this.$scope.currentCoords = {
          x: coords.x,
          y: coords.y
        } : this.$scope.currentCoords = {x: $(window).width() / 2, y: $(window).height() / 2}, this.$scope.$apply()
      }.bind(this)
  ...
  9: [function (require, module, exports) {
    var angular = require("angular"), debounce = require("throttle-debounce/debounce"),
      controller = angular.module("controller.menu", []), content = require("../../content/content.json"),
    ...
    menuController.prototype._init = function () {
      ...
      this.container.animate({scrollLeft: position}, {duration: 300, easing: "linear", queue: !1})
      ...
      var active = 0, position = 0;
      if (this.$scope.isMobile) {
        if ("forward" == target || "back" == target) return;
        this._buildOffsets(), this.container.animate({scrollTop: this.offsets[target] - 100}, 1e3)
      } else {
        if (this._buildOffsets(), "forward" == target || "back" == target) for (var i = 0; i < this.offsets.length; i++) this.offsets[i] < this.container.scrollLeft() + ("forward" == target ? 120 : -120) && (active = i); else active = target;
        switch (target) {
          case"forward":
        ...
        this.container.animate({scrollLeft: position - 100}, 1e3)
      }
      ...
      if (this.$scope.isMobile) if (this.container.scrollTop() - this.container[0].scrollHeight + this.container.height() > -150) this.$scope.section = this.offsets.length - 1; else for (var i = 0; i < this.offsets.length; i++) this.offsets[i] < this.container.scrollTop() + this.halfHeight && (this.$scope.section = i); else if (0 === this.container.scrollLeft() ? this.$scope.showBack = !1 : this.$scope.showBack = !0, this.container.scrollLeft() === this.container[0].scrollWidth - this.container.width()) this.$scope.showForward = !1, this.$scope.section = this.offsets.length - 1; else {
      ...
      this.$timeout(function () {
        ...
        this.$element.find(".menuItem").on("mouseenter", function (event) {
          var $this = $(this), direction = that._getDir($this, {x: event.pageX, y: event.pageY});
          $this.attr("data-mouse-direction", 1 === direction ? "right" : "left")
        })
      }.bind(this))
    }, menuController.prototype._getDir = function ($el, coordinates) {
      var w = $el.width(), h = $el.height(), x = (coordinates.x - $el.offset().left - w / 2) * (w > h ? h / w : 1),
        y = (coordinates.y - $el.offset().top - h / 2) * (h > w ? w / h : 1),
        direction = Math.round((Math.atan2(y, x) * (180 / Math.PI) + 180) / 90 + 3) % 4;
      return direction
    }, controller.controller("menuController", menuController), module.exports = controller
  }, {"../../content/content.json": 1, angular: 26, "throttle-debounce/debounce": 27}],
  10: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.pano", []),
    ...
    panoController.prototype._init = function () {
      this.$scope.showOverlay = !1, "smartphone" == this.configService.size && this.$rootScope.$broadcast("header--force"), this.center = {
        ...
        this.initial && this.$rootScope.$broadcast("initial--loaded"), this.map = new google.maps.Map(this.$element.find("#pano-container")[0], {
          ...
          mapTypeControlOptions: {mapTypeIds: ["bearsear"]}
        });
        var bearsearMapType = new google.maps.ImageMapType({
          ...
          }.bind(this), tileSize: new google.maps.Size(256, 256), maxZoom: 6, minZoom: 0, name: "Bearsear"
        });
      ...
      return y < 0 || y >= tileRange || x < 0 || x >= tileRange ? null : {x: x, y: y}
      ...
      this.map.setOptions({minZoom: currentMinZoom, zoom: currentMinZoom}), this.map.panTo({lat: 0, lng: 0});
      for (var view = this.map.getBounds(); !this.allowedBounds.contains(view.getNorthEast()) || !this.allowedBounds.contains(view.getSouthWest());) currentMinZoom += 1, this.map.setOptions({
        ...
        zoom: currentMinZoom
      }), this.map.panTo({lat: 0, lng: 0}), view = this.map.getBounds()
      ...
      var view = this.map.getBounds(), viewTop = view.getNorthEast().lat(), viewRight = view.getNorthEast().lng(),
        viewBottom = view.getSouthWest().lat(), viewLeft = view.getSouthWest().lng(),
        newCenterLat = this.map.getCenter().lat(), newCenterLng = this.map.getCenter().lng();
  ...
  11: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.streetview", []),
    ...
    streetviewController.prototype.init = function () {
      ...
      var currentPov = this.panorama.getPov(), zoom = this.panorama.getZoom(), width = window.innerWidth,
        height = window.innerHeight, target = {left: width / 2, top: height / 2},
        zoom3dFov = zoom <= 2 ? 126.5 - 36.75 * zoom : 195.93 / Math.pow(1.92, zoom), fov = zoom3dFov * this.DEG_TO_RAD,
        h0 = currentPov.heading * this.DEG_TO_RAD, p0 = currentPov.pitch * this.DEG_TO_RAD,
        h = targetPov.heading * this.DEG_TO_RAD, p = targetPov.pitch * this.DEG_TO_RAD,
        f = width / 2 / Math.tan(fov / 2), cos_p = Math.cos(p), sin_p = Math.sin(p), cos_h = Math.cos(h),
        sin_h = Math.sin(h), x = f * cos_p * sin_h, y = f * cos_p * cos_h, z = f * sin_p, cos_p0 = Math.cos(p0),
        sin_p0 = Math.sin(p0), cos_h0 = Math.cos(h0), sin_h0 = Math.sin(h0), x0 = f * cos_p0 * sin_h0,
        y0 = f * cos_p0 * cos_h0, z0 = f * sin_p0, nDotD = x0 * x + y0 * y + z0 * z,
        nDotC = x0 * x0 + y0 * y0 + z0 * z0;
      if (Math.abs(nDotD) < 1e-6) return null;
      var t = nDotC / nDotD;
      if (t < 0) return null;
      var tx = t * x, ty = t * y, tz = t * z, vx = -sin_p0 * sin_h0, vy = -sin_p0 * cos_h0, vz = cos_p0, ux = cos_h0,
        uy = -sin_h0, uz = 0, ul = Math.sqrt(ux * ux + uy * uy + uz * uz);
      ux /= ul, uy /= ul, uz /= ul;
      var du = tx * ux + ty * uy + tz * uz, dv = tx * vx + ty * vy + tz * vz;
  ...
  12: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.takeaction", []),
      content = require("../../content/content.json"),
    ...
    takeactionController.prototype._init = function () {
      this.initialized = !0, function (d, s, id) {
  ...
  13: [function (require, module, exports) {
    var angular = require("angular"), controller = angular.module("controller.video", []),
    ...
    videoController.prototype._init = function () {
      ...
      var vjsButton = videojs.getComponent("Button"), mapIcon = "url(./assets/map/" + this.content.mapIcon + ")",
      ...
      this.player = new YT.Player(this.$element.find("#player")[0], {
        ...
        playerVars: {autoplay: 1, showinfo: 0, controls: 0, rel: 0, modestbranding: 1, playsinline: 1},
        events: {onStateChange: this._onYTPlayerStateChange.bind(this), onReady: this._onYTPlayerReady.bind(this)}
      })
      ...
      var playerSettings = {controlBar: {children: ["playToggle", "progressControl", "currentTimeDisplay", "durationDisplay", "fullscreenToggle"]}};
      ...
      var videoElement = this.$element.find("#playervr")[0], width = videoElement.offsetWidth,
  ...
  14: [function (require, module, exports) {
    var angular = require("angular"), directive = angular.module("directive.mousetouch", []),
  ...
  15: [function (require, module, exports) {
    var angular = require("angular"), filter = angular.module("filter.minutes", []), minutesFilter = function () {
      return function (time) {
        time = Math.floor(time);
        var minutes = Math.floor(time / 60), seconds = time - 60 * minutes;
  ...
  16: [function (require, module, exports) {
    var angular = require("angular"), throttle = require("throttle-debounce/throttle"),
      debounce = require("throttle-debounce/debounce"), service = angular.module("service.config", []),
    ...
    configService.prototype.init = function () {
      ...
      var width = width ? width : $(window).width(), fillWidthHeight = 9 * width / 16,
        height = height ? height : $(window).height(), fillHeightWidth = 16 * height / 9;
      if (fillWidthHeight < height) var fillWidth = fillHeightWidth,
        fillHeight = 9 * fillWidth / 16; else var fillHeight = fillWidthHeight, fillWidth = 16 * fillHeight / 9;
      return {height: fillHeight, width: fillWidth}
  ...
  }, {angular: 26, "throttle-debounce/debounce": 27, "throttle-debounce/throttle": 28}],
  17: [function (require, module, exports) {
    var angular = require("angular"), service = angular.module("service.map", []), mapService = function ($window, $q) {
      ...
      return asyncLoad(asyncUrl, "googleMapsInitialized"), {mapsInitialized: mapsDefer.promise}
    };
    service.service("mapService", mapService), module.exports = service
  }, {angular: 26}],
  18: [function (require, module, exports) {
    var angular = require("angular"), service = angular.module("service.router", []),
      content = require("../../content/content.json"), routerService = function ($location, $rootScope) {
  ...
  19: [function (require, module, exports) {
    var angular = require("angular"), service = angular.module("service.state", []),
      content = require("../../content/content.json"),
  ...
  23: [function (require, module, exports) {
    !function (window, angular) {
      ...
      var TRANSITION_PROP, TRANSITIONEND_EVENT, ANIMATION_PROP, ANIMATIONEND_EVENT, ELEMENT_NODE = 1,
        ADD_CLASS_SUFFIX = "-add", REMOVE_CLASS_SUFFIX = "-remove", EVENT_CLASS_PREFIX = "ng-",
        ACTIVE_CLASS_SUFFIX = "-active", PREPARE_CLASS_SUFFIX = "-prepare", NG_ANIMATE_CLASSNAME = "ng-animate",
        NG_ANIMATE_CHILDREN_DATA = "$$ngAnimateChildren", CSS_PREFIX = "";
      ...
      var copy, extend, forEach, isArray, isDefined, isElement, isFunction, isObject, isString, isUndefined, jqLite,
        noop, DURATION_KEY = "Duration", PROPERTY_KEY = "Property", DELAY_KEY = "Delay", TIMING_KEY = "TimingFunction",
        ANIMATION_ITERATION_COUNT_KEY = "IterationCount", ANIMATION_PLAYSTATE_KEY = "PlayState",
        SAFE_FAST_FORWARD_DURATION_VALUE = 9999, ANIMATION_DELAY_PROP = ANIMATION_PROP + DELAY_KEY,
        ANIMATION_DURATION_PROP = ANIMATION_PROP + DURATION_KEY, TRANSITION_DELAY_PROP = TRANSITION_PROP + DELAY_KEY,
        ...
        CLOSING_TIME_BUFFER = 1.5, DETECT_CSS_PROPERTIES = {
              ...
              function start() {
                function triggerAnimationStart() {
                  if (!animationClosed) {
                    ...
                    var timerTime = maxDelayTime + CLOSING_TIME_BUFFER * maxDurationTime, endTime = startTime + timerTime,
                      animationsData = element.data(ANIMATE_TIMER_KEY) || [], setupFallbackTimer = !0;
          ...
          var NG_ANIMATE_SHIM_CLASS_NAME = "ng-animate-shim", NG_ANIMATE_ANCHOR_CLASS_NAME = "ng-anchor",
            NG_OUT_ANCHOR_CLASS_NAME = "ng-anchor-out", NG_IN_ANCHOR_CLASS_NAME = "ng-anchor-in";
          this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function ($animateCss, $rootScope, $$AnimateRunner, $rootElement, $sniffer, $$jqLite, $document) {
            ...
            function prepareFromToAnchorAnimation(from, to, classes, anchors) {
              var fromAnimation = prepareRegularAnimation(from, noop), toAnimation = prepareRegularAnimation(to, noop),
                anchorAnimations = [];
        ...
        $$AnimateQueueProvider = ["$animateProvider", function ($animateProvider) {
          ...
          rules.join.push(function (newAnimation, currentAnimation) {
            ...
            function queueAnimation(originalElement, event, initialOptions) {
              ...
              var options = copy(initialOptions), element = stripCommentsFromElement(originalElement),
                node = getDomNode(element), parentNode = node && node.parentNode;
              ...
              var isStructural = ["enter", "move", "leave"].indexOf(event) >= 0, documentHidden = $$isDocumentHidden(),
            ...
            function areAnimationsAllowed(node, parentNode, event) {
              var animateChildren, bodyNode = $document[0].body, rootNode = getDomNode($rootElement),
                bodyNodeDetected = node === bodyNode || "HTML" === node.nodeName, rootNodeDetected = node === rootNode,
                parentAnimationDetected = !1, elementDisabled = disabledElementsLookup.get(node),
            ...
            var activeAnimationsLookup = new $$Map, disabledElementsLookup = new $$Map, animationsEnabled = null,
              ...
              }), callbackRegistry = Object.create(null), classNameFilter = $animateProvider.classNameFilter(),
          ...
          var NG_ANIMATE_REF_ATTR = "ng-animate-ref", drivers = this.drivers = [],
          ...
          this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$Map", "$$rAFScheduler", function ($$jqLite, $rootScope, $injector, $$AnimateRunner, $$Map, $$rAFScheduler) {
            function sortAnimations(animations) {
              ...
              var i, tree = {children: []}, lookup = new $$Map;
            ...
            return function (element, event, options) {
              function getAnchorNodes(node) {
                var SELECTOR = "[" + NG_ANIMATE_REF_ATTR + "]",
                  items = node.hasAttribute(NG_ANIMATE_REF_ATTR) ? [node] : node.querySelectorAll(SELECTOR), anchors = [];
    ...
    !function (window) {
      ...
      function minErr(module, ErrorConstructor) {
        return ErrorConstructor = ErrorConstructor || Error, function () {
          var paramPrefix, i, SKIP_INDEXES = 2, templateArgs = arguments, code = templateArgs[0],
      ...
      function allowAutoBootstrap(document) {
        var script = document.currentScript, src = script && script.getAttribute("src");
        if (!src) return !0;
      ...
      function jqLiteOff(element, type, fn, unsupported) {
        ...
        } else for (type in events) "$destroy" !== type && element.removeEventListener(type, handle), delete events[type]
      }
      ...
      function jqLiteData(element, key, value) {
        if (jqLiteAcceptsData(element)) {
          var prop, isSimpleSetter = isDefined(value), isSimpleGetter = !isSimpleSetter && key && !isObject(key),
      ...
      function Browser(window, document, $log, $sniffer) {
        ...
        var self = this, location = window.location, history = window.history, setTimeout = window.setTimeout,
          clearTimeout = window.clearTimeout, pendingDeferIds = {};
        self.isMock = !1;
      ...
      function $CompileProvider($provide, $$sanitizeUriProvider) {
        ...
        var hasDirectives = {}, Suffix = "Directive", COMMENT_DIRECTIVE_REGEXP = /^\s*directive:\s*([\w-]+)\s+(.*)$/,
          CLASS_DIRECTIVE_REGEXP = /(([\w-]+)(?::([^;]+))?;?)/,
          ALL_OR_NOTHING_ATTRS = makeMap("ngSrc,ngSrcset,src,srcset"),
          REQUIRE_PREFIX_REGEXP = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, EVENT_HANDLER_ATTR_REGEXP = /^(on[a-z]+|formaction)$/,
        ...
        this.cssClassDirectivesEnabled = function (value) {
          ...
          function addDirective(tDirectives, name, location, maxPriority, ignoreDirective, startAttrName, endAttrName) {
            ...
            var match = null;
            if (hasDirectives.hasOwnProperty(name)) for (var directive, directives = $injector.get(name + Suffix), i = 0, ii = directives.length; i < ii; i++) if (directive = directives[i], (isUndefined(maxPriority) || maxPriority > directive.priority) && directive.restrict.indexOf(location) !== -1) {
          ...
          function addAttrInterpolateDirective(node, directives, value, name, isNgAttr) {
            var trustedContext = getTrustedContext(node, name), mustHaveExpression = !isNgAttr,
          ...
          function initializeDirectiveBindings(scope, attrs, destination, bindings, directive) {
            ...
            return forEach(bindings, function (definition, scopeName) {
              var lastValue, parentGet, parentSet, compare, removeWatch, attrName = definition.attrName,
                optional = definition.optional, mode = definition.mode;
              switch (mode) {
                case"@":
          ...
          var onChangesQueue, SIMPLE_ATTR_NAME = /^\w/, specialAttrHolder = window.document.createElement("div"),
            ...
            cssClassDirectivesEnabled = cssClassDirectivesEnabledConfig, onChangesTtl = TTL;
        ...
        this.$get = ["$browser", "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", "$sce", function ($browser, $httpBackend, $$cookieReader, $cacheFactory, $rootScope, $q, $injector, $sce) {
          ...
          function sendReq(config, reqData) {
            ...
            var cache, cachedResp, deferred = $q.defer(), promise = deferred.promise, reqHeaders = config.headers,
              isJsonp = "jsonp" === lowercase(config.method), url = config.url;
        ...
        this.digestTtl = function (value) {
          ...
          Scope.prototype = {
            constructor: Scope, $new: function (isolate, parent) {
              ...
              return lastDirtyWatch = null, isFunction(listener) || (watcher.fn = noop), array || (array = scope.$$watchers = [], array.$$digestWatchIndex = -1), array.unshift(watcher), array.$$digestWatchIndex++, incrementWatchersCount(this, 1), function () {
              ...
              var newValue, oldValue, veryOldValue, self = this, trackVeryOldValue = listener.length > 1,
                changeDetected = 0, changeDetector = $parse(obj, $watchCollectionInterceptor), internalArray = [],
                internalObject = {}, initRun = !0, oldLength = 0;
              return this.$watch(changeDetector, $watchCollectionAction)
            }, $digest: function () {
              var watch, value, last, fn, get, watchers, dirty, next, current, logIdx, asyncTask, ttl = TTL,
                target = this, watchLog = [];
      ...
      function $SnifferProvider() {
        this.$get = ["$window", "$document", function ($window, $document) {
          var eventSupport = {}, isNw = $window.nw && $window.nw.process,
      ...
      function formatNumber(number, pattern, groupSep, decimalSep, fractionSize) {
        ...
        var parsedNumber, isInfinity = !isFinite(number), isZero = !1, numStr = Math.abs(number) + "",
          formattedText = "";
      ...
      function dateStrGetter(name, shortForm, standAlone) {
        return function (date, formats) {
          var value = date["get" + name](), propPrefix = (standAlone ? "STANDALONE" : "") + (shortForm ? "SHORT" : ""),
      ...
      function weekGetter(size) {
        return function (date) {
          var firstThurs = getFirstThursdayOfYear(date.getFullYear()), thisThurs = getThursdayThisWeek(date),
            diff = +thisThurs - +firstThurs, result = 1 + Math.round(diff / 6048e5);
      ...
      function orderByFilter($parse) {
        ...
        return function (array, sortPredicate, reverseOrder, compareFn) {
          ...
          var predicates = processPredicates(sortPredicate), descending = reverseOrder ? -1 : 1,
      ...
      function isValidForStep(viewValue, stepBase, step) {
        var value = Number(viewValue), isNonIntegerValue = !isNumberInteger(value),
          isNonIntegerStepBase = !isNumberInteger(stepBase), isNonIntegerStep = !isNumberInteger(step);
      ...
      function rangeInputType(scope, element, attr, ctrl, $sniffer, $browser) {
        ...
        var supportsRange = ctrl.$$hasNativeValidators && "range" === element[0].type,
          minVal = supportsRange ? 0 : void 0, maxVal = supportsRange ? 100 : void 0,
          stepVal = supportsRange ? 1 : void 0, validity = element[0].validity, hasMinAttr = isDefined(attr.min),
          hasMaxAttr = isDefined(attr.max), hasStepAttr = isDefined(attr.step), originalRender = ctrl.$render;
          ...
          return {
            restrict: "AC", link: function (scope, element, attr) {
              ...
              function updateClasses(oldClassString, newClassString) {
                var oldClassArray = split(oldClassString), newClassArray = split(newClassString),
                  toRemoveArray = arrayDifference(oldClassArray, newClassArray),
                  toAddArray = arrayDifference(newClassArray, oldClassArray),
                  toRemoveString = digestClassCounts(toRemoveArray, -1), toAddString = digestClassCounts(toAddArray, 1);
              ...
              var oldClassString, expression = attr[name].trim(),
                ...
                classCounts = element.data("$classCounts"), oldModulo = !0;
      ...
      var msie, jqLite, jQuery, angularModule, slice = [].slice, splice = [].splice, push = [].push,
        toString = Object.prototype.toString, getPrototypeOf = Object.getPrototypeOf, ngMinErr = minErr("ng"),
      ...
      var isArray = Array.isArray,
        ...
        }, ALL_COLONS = /:/g, ngAttrPrefixes = ["ng-", "data-ng-", "ng:", "x-ng-"],
        isAutoBootstrapAllowed = allowAutoBootstrap(window.document), SNAKE_CASE_REGEXP = /[A-Z]/g,
        bindJQueryFired = !1, NODE_TYPE_ELEMENT = 1, NODE_TYPE_ATTRIBUTE = 2, NODE_TYPE_TEXT = 3, NODE_TYPE_COMMENT = 8,
        NODE_TYPE_DOCUMENT = 9, NODE_TYPE_DOCUMENT_FRAGMENT = 11,
        version = {full: "1.6.2", major: 1, minor: 6, dot: 2, codeName: "llamacorn-lovehug"};
      JQLite.expando = "ng339";
      var jqCache = JQLite.cache = {}, jqId = 1;
      JQLite._data = function (node) {
        return this.cache[node[this.expando]] || {}
      };
      var DASH_LOWERCASE_REGEXP = /-([a-z])/g, MS_HACK_REGEXP = /^-ms-/,
        MOUSE_EVENT_MAP = {mouseleave: "mouseout", mouseenter: "mouseover"}, jqLiteMinErr = minErr("jqLite"),
        SINGLE_TAG_REGEXP = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, HTML_REGEXP = /<|&#?\w+;/, TAG_NAME_REGEXP = /<([\w:-]+)/,
        XHTML_TAG_REGEXP = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, wrapMap = {
      ...
      var jqLiteContains = window.Node.prototype.contains || function (arg) {
        ...
        ready: jqLiteReady, toString: function () {
          var value = [];
      ...
      forEach({
        ...
        triggerHandler: function (element, event, extraParameters) {
          var dummyEvent, eventFnsCopy, handlerArgs, eventName = event.type || event,
            expandoStore = jqLiteExpandoStore(element), events = expandoStore && expandoStore.events,
      ...
      var $animateMinErr = minErr("$animate"), ELEMENT_NODE = 1, NG_ANIMATE_CLASSNAME = "ng-animate",
      ...
      var PREFIX_REGEXP = /^((?:x|data)[:\-_])/i, SPECIAL_CHARS_REGEXP = /[:\-_]+(.)/g,
        $controllerMinErr = minErr("$controller"), CNTRL_REG = /^(\S+)(\s+as\s+([\w$]+))?$/,
      ...
      var $jsonpCallbacksProvider = function () {
            ...
            return {
              createCallback: function (url) {
                var callbackId = "_" + (callbacks.$$counter++).toString(36),
                  callbackPath = "angular.callbacks." + callbackId, callback = createCallback(callbackId);
        ...
        }, PATH_MATCH = /^([^?#]*)(\?([^#]*))?(#(.*))?$/, DEFAULT_PORTS = {http: 80, https: 443, ftp: 21},
      ...
      AST.Program = "Program", AST.ExpressionStatement = "ExpressionStatement", AST.AssignmentExpression = "AssignmentExpression", AST.ConditionalExpression = "ConditionalExpression", AST.LogicalExpression = "LogicalExpression", AST.BinaryExpression = "BinaryExpression", AST.UnaryExpression = "UnaryExpression", AST.CallExpression = "CallExpression", AST.MemberExpression = "MemberExpression", AST.Identifier = "Identifier", AST.Literal = "Literal", AST.ArrayExpression = "ArrayExpression", AST.Property = "Property", AST.ObjectExpression = "ObjectExpression", AST.ThisExpression = "ThisExpression", AST.LocalsExpression = "LocalsExpression", AST.NGValueParameter = "NGValueParameter", AST.prototype = {
        ...
        compile: function (expression) {
          ...
          switch (ast.type) {
            ...
            case AST.AssignmentExpression:
              return left = this.recurse(ast.left, !0, 1), right = this.recurse(ast.right), function (scope, locals, assign, inputs) {
                ...
                return lhs.context[lhs.name] = rhs, context ? {value: rhs} : rhs
              };
            case AST.ArrayExpression:
          ...
          return function (scope, locals, assign, inputs) {
            ...
            return context ? {context: lhs, name: right, value: value} : value
          }
      ...
      var $sceMinErr = minErr("$sce"),
        ...
        UNDERSCORE_LOWERCASE_REGEXP = /_([a-z])/g, $templateRequestMinErr = minErr("$compile"),
        urlParsingNode = window.document.createElement("a"), originUrl = urlResolve(window.location.href);
      ...
      FormController.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"], FormController.prototype = {
        ...
        clazz: FormController, set: function (object, property, controller) {
      ...
      var formDirectiveFactory = function (isNgForm) {
        ...
        NUMBER_REGEXP = /^\s*(-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, DATE_REGEXP = /^(\d{4,})-(\d{2})-(\d{2})$/,
        DATETIMELOCAL_REGEXP = /^(\d{4,})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,
        WEEK_REGEXP = /^(\d{4,})-W(\d\d)$/, MONTH_REGEXP = /^(\d{4,})-(\d\d)$/,
        TIME_REGEXP = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, PARTIAL_VALIDATION_EVENTS = "keydown wheel mousedown",
      ...
      var ngIfDirective = ["$animate", "$compile", function ($animate, $compile) {
        ...
        ngIncludeDirective = ["$templateRequest", "$anchorScroll", "$animate", function ($templateRequest, $anchorScroll, $animate) {
          ...
          return {
            restrict: "A", priority: 100, require: "ngModel", link: function (scope, element, attr, ctrl) {
              var ngList = attr.ngList || ", ", trimValues = "false" !== attr.ngTrim,
        ...
        DIRTY_CLASS = "ng-dirty", UNTOUCHED_CLASS = "ng-untouched", TOUCHED_CLASS = "ng-touched",
        EMPTY_CLASS = "ng-empty", NOT_EMPTY_CLASS = "ng-not-empty", ngModelMinErr = minErr("ngModel");
      NgModelController.$inject = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$q", "$interpolate"], NgModelController.prototype = {
        $$initGetterSetters: function () {
          if (this.$options.getOption("getterSetter")) {
            ...
            this.$$ngModelGet = function ($scope) {
              ...
              isFunction(this.$$parsedNgModel($scope)) ? invokeModelSetter($scope, {$$$p: newValue}) : this.$$parsedNgModelAssign($scope, newValue)
            }
        ...
        }, $render: noop, $isEmpty: function (value) {
          ...
          if (!isNumberNaN(this.$modelValue)) {
            var viewValue = this.$$lastCommittedViewValue, modelValue = this.$$rawModelValue, prevValid = this.$valid,
              prevModelValue = this.$modelValue, allowInvalid = this.$options.getOption("allowInvalid"), that = this;
          ...
          if (this.$$parserValid = !isUndefined(modelValue) || void 0, this.$$parserValid) for (var i = 0; i < this.$parsers.length; i++) if (modelValue = this.$parsers[i](modelValue), isUndefined(modelValue)) {
            this.$$parserValid = !1;
            break
          }
        ...
        clazz: NgModelController, set: function (object, property) {
          object[property] = !0
      ...
      var ngModelOptionsDirective = function () {
        ...
        }, ngNonBindableDirective = ngDirective({terminal: !0, priority: 1e3}), ngOptionsMinErr = minErr("ngOptions"),
            ...
            return {
              ...
              getOptions: function () {
                for (var optionItems = [], selectValueMap = {}, optionValues = valuesFn(scope) || [], optionValuesKeys = getOptionValuesKeys(optionValues), optionValuesLength = optionValuesKeys.length, index = 0; index < optionValuesLength; index++) {
                  var key = optionValues === optionValuesKeys ? index : optionValuesKeys[index],
                    value = optionValues[key], locals = getLocals(value, key), viewValue = viewValueFn(scope, locals),
                    selectValue = getTrackByValueFn(viewValue, locals), label = displayFn(scope, locals),
                    group = groupByFn(scope, locals), disabled = disableWhenFn(scope, locals),
            ...
            compile: function ($element, $attr) {
              ...
              return trackByExp ? trackByExpGetter = $parse(trackByExp) : (trackByIdArrayFn = function (key, value) {
                ...
                $scope.$watchCollection(rhs, function (collection) {
                  var index, length, nextNode, collectionLength, key, value, trackById, trackByIdFn, collectionKeys,
                    block, nextBlockOrder, elementsToRemove, previousNode = $element[0], nextBlockMap = createMap();
        ...
        }], NG_HIDE_CLASS = "ng-hide", NG_HIDE_IN_PROGRESS_CLASS = "ng-hide-animate",
  ...
  28: [function (require, module, exports) {
    module.exports = function (delay, noTrailing, callback, debounceMode) {
      function wrapper() {
        ...
        var self = this, elapsed = Number(new Date) - lastExec, args = arguments;
